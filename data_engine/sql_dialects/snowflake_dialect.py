"""
DataFlowX Snowflake Dialect SQL Generator
Generates Snowflake SQL statements from AST nodes with VARIANT parsing (col:key::string), zero-copy clones, and stages.
"""
...
class SnowflakeDialectGenerator:
    """Generates Snowflake SQL statements from SelectQueryAST."""
    ...
    def generate(cls, ast: SelectQueryAST) -> str:
        ...
        for p in ast.projections:
            ...
            if p.alias:
                proj_strs.append(f'{expr_str} AS "{p.alias.upper()}"')
            else:
