"""
DataFlowX DuckDB Dialect SQL Generator
Generates DuckDB vectorized SQL queries from AST nodes with Parquet scan macros and zero-copy filters.
"""
...
class DuckDBDialectGenerator:
    """Generates DuckDB SQL from SelectQueryAST."""
