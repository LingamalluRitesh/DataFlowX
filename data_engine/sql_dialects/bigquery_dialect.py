"""
DataFlowX Google BigQuery Dialect SQL Generator
Generates standard GoogleSQL statements from AST nodes with backtick table formatting, STRUCT parsing, and UNNEST arrays.
"""
...
class BigQueryDialectGenerator:
    """Generates Google BigQuery standard SQL from SelectQueryAST."""
